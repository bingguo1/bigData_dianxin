...
public class HBaseDao extends BaseDao {
    public void init() throws Exception {
        System.out.println("in HBaseDao init------- start");

        start();
        System.out.println("in HBaseDao init------- create namespace");
        createNamepsaceNX(Names.NAMESPACE.getValue());
        System.out.println("in HBaseDao init------- create table");
  //      createTableXX(Names.TABLE.getValue(), "com.atguigu.ct.consumer.coprocessor.InsertCalleeCoprocessor", ValueConstant.REGION_COUNT, Names.CF_CALLER.getValue(), Names.CF_CALLEE.getValue());
       createTableXX(Names.TABLE.getValue(), null, ValueConstant.REGION_COUNT, Names.CF_CALLER.getValue(), Names.CF_CALLEE.getValue());
        System.out.println("in HBaseDao init------- end");
        end();
    }
    ...
    public void insertData(String value) throws Exception {
        ...
        String calleeRowkey= genRegionNum(call2, calltime) + "_"+call1+"_"+calltime+"_"+call2+"_"+duration+"_0";
